...
const vaibhavBot = () => {
  ...
  $(".js-beacon").click(function(e) {
    ...
    Beacon("open");
    $(".js-beacon").blur();
    $("#c-vaibhavbot").addClass("hide");
  });

  $(".js-vaibhavbot").click(function(e) {
    e.preventDefault();
    Beacon("close");
    $(".js-vaibhavbot").blur();
    $("#c-vaibhavbot").removeClass("hide");
    $(".c-fab").addClass("hide");

    $("#c-new-content").empty();
    $(".c-vaibhavbot__content .c-vaibhavbot__options").removeClass("hide").addClass("active");
  });

  $(".js-vaibhavbot-exit").click(function(e) {
    e.preventDefault();
    Beacon("close");
    $(".js-vaibhavbot-exit").blur();
    $("#c-vaibhavbot").addClass("hide");
  ...
  $(".c-vaibhavbot__button").click(function(e) {
    var $this = $(this);
    e.preventDefault();
    ...
    var $answer = "#c-vaibhavbot-q .c-vaibhavbot__answer--" + $data;
    var $updated = "c-vaibhavbot__answer--" + $id;
    var $location = "#c-new-content";
    var $buttons = ".c-vaibhavbot__options";
    ...
    $($animationId).each(function(index){
        ...
        setTimeout(function () {
          ...
          var msgDiv = $("#c-vaibhavbot-content");
